// Write a program that takes three things as input from the user, n (n is always even), which is the number of containers, 
// “l” and “u”. Now form an array of n size with lowest value as l and upper value as u with equal difference between any 2 consecutive elements of the array. 
// The array formed when taken in pairs from index 0 to n-1 form a container, with radius being the first element of the pair and height being the second. 
